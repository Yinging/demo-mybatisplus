...
CREATE TABLE `sys_dict_data`  (
  ...
  `sort` int(0) NULL DEFAULT 0 COMMENT '字典排序',
...
CREATE TABLE `sys_logininfor`  (
  ...
  `username` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '登录账号',
...
CREATE TABLE `sys_oper_log`  (
  `id` int(0) NOT NULL AUTO_INCREMENT COMMENT '日志主键',
...
CREATE TABLE `sys_user`  (
  ...
  `real_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '用户昵称',
